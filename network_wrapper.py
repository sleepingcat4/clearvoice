...
class network_wrapper(nn.Module):
    ...
    def load_args_se(self):
        ...
        """
        self.config_path = self.config_path or 'config/inference/' + self.model_name + '.yaml'  # Use custom config path if provided
    ...
    def load_args_ss(self):
        ...
        """
        self.config_path = self.config_path or 'config/inference/' + self.model_name + '.yaml'
        parser = yamlargparse.ArgumentParser("Settings")
    ...
    def load_args_tse(self):
        ...
        parser.add_argument('--network_reference', type=dict, help='A dictionary that contains the parameters of the auxiliary reference signal')
    ...
    def __call__(self, task, model_name, config_path=None):
        """
        ...
        - config_path (str, optional): The path to the custom configuration file.
        ...
        self.config_path = config_path  # Set the custom config path if provided
